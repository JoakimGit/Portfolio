...
const ProjectDetails = ({ data }) => {
  ...
  return (
    <div>
      <Layout>
        <Link
          className="bg-clr-dark text-clr-light hover:text-clr-light/80 relative left-4 top-4 rounded-lg p-2 font-black"
          to="/"
        >
          Go back
        </Link>
        ...
        <section
          className="gap-x-4 px-8 pt-20 pb-8 lg:mx-auto lg:grid lg:w-min lg:grid-cols-[min-content_max-content] lg:pt-40"
          id="home"
        >
